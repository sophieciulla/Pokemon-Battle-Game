...
public class PokemonVersion
	{
		...
		{
			dictionary.add(new Pokemon("Bulbasaur", 1, "Grass", "Tackle 40", 40, "Vine Whip 40", 40, "None", 0, "None", 0, 5 ,20 ,20 ,10 ,1 ));
			...
			dictionary.add(new Pokemon("Charmander", 4, "Fire",  "Scratch 40", 40, "Ember 40", 40, "None", 0, "None", 0, 5, 20, 20, 10, 2));
			...
			dictionary.add(new Pokemon("Squirtle", 7, "Water", "Tackle 40", 40, "Water Gun 40", 40, "None", 0, "None", 0, 5, 20, 20, 10, 2));
